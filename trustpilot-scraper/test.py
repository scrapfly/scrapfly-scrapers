...
async def test_review_scraping():
    reviews_data = await trustpilot.scrape_reviews(
        url="https://www.trustpilot.com/_next/data/businessunitprofile-consumersite-2.21.0/review/www.bhphotovideo.com.json?sort=recency&businessUnit=www.bhphotovideo.com",
        max_pages=3,
    )
